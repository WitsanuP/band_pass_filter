...
std::vector<double> applyFIRFilter(const std::vector<double>& input, const std::vector<double>& weights) {
...
int main() {
    ...
    std::string outputFilename = "output.txt";   // Output destination file
